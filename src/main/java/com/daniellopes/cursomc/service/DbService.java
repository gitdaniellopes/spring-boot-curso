...
import com.daniellopes.cursomc.repository.*;
...
public class DbService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Categoria cat7 = new Categoria(null, "Permumaria");
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva",
                "casa02jf@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA,
                passwordEncoder.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("3232-5547", "3245-5878"));


        Cliente cli2 = new Cliente(null, "Ana Costa",
                "casa02@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA,
                passwordEncoder.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("3248-5687", "33698-8898"));


        Endereco e1 = new Endereco(null, "Rua Flores",
                "300", "Apto 303", "Jardim", "36031568",
                cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos",
                "105", "Sala 800", "Centro", "38456987",
                cli1, c2);

        Endereco e3 = new Endereco(null, "Avenida Floriano",
                "2006", null, "Centro", "38456987",
                cli2, c2);
        ...
        PagamentoComCartao pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO,
                ped1, 6);
        ped1.setPagamento(pagto1);

        PagamentoComBoleto pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE,
